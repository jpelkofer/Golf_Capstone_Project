...
# Start of Kmeans
```{r}
adj_dk_pts_gained_2016_17_18 <- read_csv("past_holes_categorized/adj_dk_pts_gained_2016_17_18.csv")
...
kmeans_skree <- 
  ...
  theme_minimal() +
  labs(title = "<b>Figure 1</b>
       <br>",
       subtitle = "<b><em>K-Means Skree Plot</em></b>
       <br>
       <br>") +
  theme(
